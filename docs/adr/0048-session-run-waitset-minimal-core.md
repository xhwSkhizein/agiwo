...
This decision supersedes the Objective/Assignment control chain (formerly ADR 0003–0040, 0044, 0046, 0047, and related pause/budget/fault ADRs). Archived copies live under `trash/adr-superseded-by-0048-*`; see `docs/adr/README.md`. Switching is breaking: clear development databases; no migration.
