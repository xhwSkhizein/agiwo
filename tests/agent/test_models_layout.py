...
def test_models_package_exposes_domain_specific_modules() -> None:
    ...
    memory_module = importlib.import_module("agiwo.agent.models.memory")
    compact_module = importlib.import_module("agiwo.agent.models.compact")
    ...
    assert hasattr(memory_module, "MemoryRecord")
    assert hasattr(compact_module, "CompactMetadata")
