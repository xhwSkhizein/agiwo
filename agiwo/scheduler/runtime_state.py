...
class RuntimeState:
    ...
    def find_handle_by_run_id(self, run_id: str) -> ExecutionHandleLike | None:
        """Find a live execution handle by run_id."""
        for handle in self.execution_handles.values():
