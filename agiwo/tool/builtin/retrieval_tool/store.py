...
class MemoryIndexStore:
    ...
    def _check_vec_extension(self) -> bool:
        ...
        try:
            ...
            logger.info("sqlite_vec_not_available", reason=str(e))
            return False
    ...
    async def _get_embeddings(
        ...
        missing_chunks = [c for c in chunks if c.content_hash not in cached]
