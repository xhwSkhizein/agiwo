"""
Agent trace collector - builds Trace from StreamEvent stream.
...
class AgentTraceCollector:
    """
    Agent trace collector - constructs Trace from StreamEvent stream.

    Usage:
        collector = AgentTraceCollector(store)
